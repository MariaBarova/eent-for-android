...
public class Tigris2 extends JFrame {
    ...
    public static JLabel infolabel , swap, ScoreBoard1 , ScoreBoard2 , ScoreBoard3 , ScoreBoard4 ;
    ...
    private ButtonListener2 a4 = new ButtonListener2();
    ...
    public JButton Cancel,
           Ok;
    public static JCheckBox jCheckBox1, jCheckBox2, jCheckBox3 , jCheckBox4 , jCheckBox5 , jCheckBox6;
   ...
   //     ScoreBoard4.setText(String.valueOf(HumanPlayer.score[2]));
    ...
    /** checks if player still has a turn and
    * if not changes to the next player and
    * resets the old players turn
    */
