...
public class ComputerPlayer extends Player {
    ...
    private int civ, chooser , lead , cat ,
    row,
    col;
    ...
    /** computerplayer makes to moves. This is done totally at
    * random and should be changed to be more compettative
    */
    public void ComputerPlay(){
        ...
        while(hasTurn()) {
            chooser = (int)(Math.random() * 3);
            civ = (int)(Math.random() * 6);
            lead = (int)(Math.random() * 4);
            cat = (int)(Math.random() * 2);
